...
namespace E_Appraisal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //Win user login checking           
                 
            service = LoadEmailObject(model.Email, model.Password);
            ...
            {
                //Get Email Userprofile
                Microsoft.Exchange.WebServices.Data.Contact userProfile = GetContactInfo(model.Email);
                ...
                ds.Filter = "(&(objectCategory=User) (mail=" + model.Email + "))";
